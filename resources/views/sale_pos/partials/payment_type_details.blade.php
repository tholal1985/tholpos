...
<div class="payment_details_div @if( $payment_line['method'] !== 'cheque' ) {{ 'hide' }} @endif" data-type="cheque" >
	...
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label("cheque_due_date_$row_index", __('cheque::lang.due_date')) !!}
			{!! Form::text("payment[$row_index][cheque_due_date]", $payment_line['cheque_due_date'] ?? '', ['class' => 'form-control date_picker', 'placeholder' => __('cheque::lang.due_date'), 'id' => "cheque_due_date_$row_index", 'readonly']); !!}
		</div>
	</div>
</div>
