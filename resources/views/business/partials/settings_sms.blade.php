...
<div class="pos-tab-content">
    <div class="row">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                {!! Form::select('sms_settings[sms_service]', ['nexmo' => 'Nexmo', 'twilio' => 'Twilio', 'ooredoo' => 'Ooredoo', 'other' => __('lang_v1.other')], $sms_service , ['class' => 'form-control', 'id' => 'sms_service']); !!}
            </div>
        </div>
    </div>
    ...
    <div class="row sms_service_settings @if($sms_service != 'ooredoo') hide @endif" data-service="ooredoo">
        <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('ooredoo_username', __('lang_v1.ooredoo_username') . ':') !!}
                {!! Form::text('sms_settings[ooredoo_username]', !empty($sms_settings['ooredoo_username']) ? $sms_settings['ooredoo_username'] : null, ['class' => 'form-control','placeholder' => __('lang_v1.ooredoo_username'), 'id' => 'ooredoo_username']); !!}
            </div>
        </div>
         <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('ooredoo_api_url', __('lang_v1.ooredoo_api_url') . ':') !!}
                {!! Form::text('sms_settings[ooredoo_api_url]', !empty($sms_settings['ooredoo_api_url']) ? $sms_settings['ooredoo_api_url'] : null, ['class' => 'form-control','placeholder' => __('lang_v1.ooredoo_api_url'), 'id' => 'ooredoo_api_url']); !!}
            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('ooredoo_token', __('lang_v1.ooredoo_token') . ':') !!}
                {!! Form::text('sms_settings[ooredoo_token]', !empty($sms_settings['ooredoo_token']) ? $sms_settings['ooredoo_token'] : null, ['class' => 'form-control','placeholder' => __('lang_v1.ooredoo_token'), 'id' => 'ooredoo_token']); !!}
            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('ooredoo_access_key', __('lang_v1.ooredoo_access_key') . ':') !!}
                {!! Form::text('sms_settings[ooredoo_access_key]', !empty($sms_settings['ooredoo_access_key']) ? $sms_settings['ooredoo_access_key'] : null, ['class' => 'form-control','placeholder' => __('lang_v1.ooredoo_access_key'), 'id' => 'ooredoo_access_key']); !!}
            </div>
        </div>
    </div>
