			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::text('expense_title', null, ['class' => 'form-control', 'placeholder' => __('expense.expense_title')]); !!}
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::text('payment_to', null, ['class' => 'form-control', 'placeholder' => __('expense.payment_to')]); !!}
					</div>
				</div>
