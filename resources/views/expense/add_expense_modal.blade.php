    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('expense_title', __('expense.expense_title').':') !!}
                        {!! Form::text('expense_title', null, ['class' => 'form-control', 'placeholder' => __('expense.expense_title'), 'id' => 'expense_title']); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('payment_to', __('expense.payment_to').':') !!}
                        {!! Form::text('payment_to', null, ['class' => 'form-control', 'placeholder' => __('expense.payment_to'), 'id' => 'expense_payment_to']); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
