      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::text('expense_title', $expense->expense_title, ['class' => 'form-control', 'placeholder' => __('expense.expense_title')]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('payment_to', __('expense.payment_to').':') !!}
            {!! Form::text('payment_to', $expense->payment_to, ['class' => 'form-control', 'placeholder' => __('expense.payment_to')]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
