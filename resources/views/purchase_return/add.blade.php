...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
				...
				<table class="table bg-gray" id="purchase_return_table">
		          	<thead>
			            <tr class="bg-green">
			              	...
			              	<th class="add_without_price_hide">@lang('sale.unit_price')</th>
			              	<th>@lang('purchase.purchase_quantity')</th>
			              	<th>@lang('lang_v1.quantity_left')</th>
			              	<th>@lang('lang_v1.return_quantity')</th>
			              	<th class="add_without_price_hide">@lang('lang_v1.return_subtotal')</th>
			            </tr>
			        </thead>
			        <tbody>
			            ...
			            <tr>
			              	...
			              	<td class="add_without_price_hide"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->purchase_price_inc_tax }}</span></td>
		...
		<div class="row add_without_price_hide">
			<div class="col-sm-4">
